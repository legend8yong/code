...
FRAME_W = 320
FRAME_H = 240
CORE_DETECT_X1 = FRAME_W // 4
CORE_DETECT_X2 = FRAME_W * 3 // 4
CORE_DETECT_Y1 = 0
CORE_DETECT_Y2 = FRAME_H * 2 // 3
DETECT_MARGIN_X = FRAME_W // 8
DETECT_MARGIN_Y = FRAME_H // 12
DETECT_X1 = max(0, CORE_DETECT_X1 - DETECT_MARGIN_X)
DETECT_X2 = min(FRAME_W, CORE_DETECT_X2 + DETECT_MARGIN_X)
DETECT_W = DETECT_X2 - DETECT_X1
DETECT_Y1 = CORE_DETECT_Y1
DETECT_Y2 = min(FRAME_H, CORE_DETECT_Y2 + DETECT_MARGIN_Y)
DETECT_H = DETECT_Y2 - DETECT_Y1
DETECT_SCALE = 1.0
DETECT_TRAPEZOID_BOTTOM_RATIO = 1.0
...
UART_SAME_KEY_REARM_MS = 90
UART_SAME_KEY_REARM_CENTER_SHIFT = 16
CENTER_JUMP_WINDOW_MS = 250
CENTER_JUMP_X_LIMIT = 55
DETECTION_CONFIRM_MS = 100
FRONT_CONFIRM_MS = 25
FAST_SWITCH_CONFIRM_MS = 40
